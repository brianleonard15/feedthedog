 ...
 * confirms that.                                                     */
 function check_response(the_form, diagnostics, limit)
 {
    found_error = false;
    for (index = 0; index < diagnostics.length; index++) {
        diagnostic = document.getElementById(diagnostics[index]);
        response   = diagnostic.value;
        ...
        if (!valid_response) {
            diagnostic.style.borderColor = "#F00";
        }
        
        else {
            diagnostic.style.borderColor = "#000";
